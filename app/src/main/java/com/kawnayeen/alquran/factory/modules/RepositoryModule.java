 ...
 */
@Module(includes = {WebServicesModule.class, DataBaseModule.class})
public class RepositoryModule {
    @Provides
    @Singleton
    public AyatRepository getAyatRepository(WebServices webServices, AyatInfoDao ayatInfoDao) {
        return new AyatRepository(webServices, ayatInfoDao);
    }
}
